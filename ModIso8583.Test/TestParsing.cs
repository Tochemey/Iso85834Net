...
namespace ModIso8583.Test
{
    public class TestParsing
    {
        ...
        {
            Assert.Throws(typeof(ParseException),
                () => mf.ParseMessage("0210B23A80012EA08018000000001400000465000".GetSbytes(),
                    0));
        }
        ...
        {
            Assert.Throws(typeof(ParseException),
                () => mf.ParseMessage("0210B23A80012EA080180000000014000004".GetSbytes(),
                    0));
        }
        ...
        {
            Assert.Throws(typeof(ParseException),
                () => mf.ParseMessage("02008000000000000000".GetSbytes(),
                    0));
        }
